import { Pool } from 'pg'
import { DBData, User, Item, Supplier, PurchaseOrder, ItemMovement, WorkOrder, Alert, SystemEvent } from './types'
...
export async function initPostgres(connectionString: string): Promise<Pool> {
